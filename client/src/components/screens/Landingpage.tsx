...
export default function Hero() {
  ...
  return (
    <div className="min-h-screen bg-black relative overflow-hidden">
      <Topbar></Topbar>        
      <div className="relative mx-auto z-10 flex flex-col items-center justify-center px-4 min-h-screen">
        {!isUserCard && <div className="text-center max-w-4xl mx-auto px-4">
